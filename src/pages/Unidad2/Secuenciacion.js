    ...
    <div class="content">
      ...
      <div class="content-section">
        ...
        <div class="subsection">
          ...
          <p>Descripción de la fase inicial de la unidad de desarrollo web.</p>
        </div>
        <div class="subsection">
          <h4>6.2. Fase de Desarrollo: Conocer, comprender, pensar, practicar y actuar</h4>
          <p>Descripción de la fase de desarrollo de la unidad de desarrollo web.</p>
        </div>
        <div class="subsection">
          <h4>6.3. Fase de Síntesis o Cierre: Compartir, evaluar y reflexionar sobre nuestros logros</h4>
          <p>Descripción de la fase de cierre de la unidad de desarrollo web.</p>
        </div>
      </div>
    </div>
  `;
...
window.Unidad2Secuenciacion = Unidad2Secuenciacion; 