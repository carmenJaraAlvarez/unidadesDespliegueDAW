function Unidad1SecuenciacionFaseInicial() {
  return `
    <div class="content">
      ...
      <div class="content-section">
        <div class="actividad-card">
          ...
          <div class="actividad-details">
            ...
            <ul>
              <li>Presentación sobre DevOps</li>
              <li>Video: "DevOps en 5 minutos"</li>
            ...
            <div class="subactividad">
              ...
              <ul>
                <li>¿Qué sabemos sobre desarrollo y operaciones?</li>
                <li>Experiencias previas en trabajo colaborativo</li>
                <li>Identificación de problemas comunes en el despliegue</li>
              </ul>
            </div>
          </div>
        </div>
...
window.Unidad1SecuenciacionFaseInicial = Unidad1SecuenciacionFaseInicial; 